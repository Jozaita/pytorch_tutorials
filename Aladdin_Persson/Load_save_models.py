...
def save_checkpoint(state_dict,filename="my_checkpoint.pth.tar"):
    print("SAVING CHECKPOINT...")
    torch.save(state_dict,"model_checkpoints/"+filename)
...
if load_model:
    load_checkpoint(torch.load("model_checkpoints/my_checkpoint.pth.tar"))
