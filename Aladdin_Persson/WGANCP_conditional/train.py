...
disc = Critic(CHANNELS_IMG,FEATURES_DISC,NUM_CLASSES,IMAGE_SIZE).to(device)
...
writer_real = SummaryWriter(f"runs/WGANGP_conditional/real")
writer_fake = SummaryWriter(f"runs/WGANGP_conditional/fake")
step = 0
